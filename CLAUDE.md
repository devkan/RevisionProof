...
- Legacy `PUNCH_IN` specs 2.x remain compatible. Current `EDIT_PLAN` specs 3.1 freeze selected original-time operations, speed/volume/logo parameters, mapped output timeline, and full-preview SHA-256. Historical 3.0 specs remain readable without the expanded fields.
