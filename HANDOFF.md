...
Full restart hydration of an in-progress run remains unimplemented. Before a submission recording, rehearse the LIVE judge path and use the approved final run as evidence. No PR or merge has been requested.
...
Read `docs/README.md`, `docs/qa-report-2026-08-26-live-final.md`, and the 2026-08-26 infrastructure inventory. Use `docs/demo-runbook.md` for the judge path. The final delivery approval has been performed for the recorded final run only.
